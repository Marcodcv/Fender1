...
<body>  
  <div class="conten">
        ...
        <?php
          ...
          $id=$_POST['id'];
          $SQL="SELECT * FROM pedidos WHERE (id LIKE '$id')";
          echo "<h2>"."BAJA DE PEDIDOS"."</h2>";
          echo "<hr>";
          echo "<br>";
          echo "<table>";
          echo "<thead>";
          ...
          echo "<th>"."Fecha:";
          echo "<th>"."Cantidad:";
          echo "<th>"."Estado Envio:";
          echo "<th>"."Total:";
          echo "<th>"."ID Empleados:";
          echo "<th>"."ID Cliente:";
          echo "<th>"."ID Producto:";
          echo "</tr>";
          echo "</thead>";
          ...
          if($fila=mysqli_fetch_array($registro))
          {
            ...
            echo "<th align=center>".$fila['fecha'];
            echo "<th align=center>".$fila['cantidad'];
            echo "<th align=center>".$fila['estadoenvio'];
            echo "<th align=center>".$fila['totalc'];
            echo "<th align=center>".$fila['Empleados_id'];
            echo "<th align=center>".$fila['idcliente'];
            echo "<th align=center>".$fila['idinventario'];
            echo "</tr>";
            echo "</table>";
            mysqli_free_result($registro);
            $consulta="DELETE FROM pedidos WHERE(id LIKE '$id')";
          ...
          else
          {
            ...
            <?php
            header("Location:../paginas/PedidDelete.html");
          }
          mysqli_close($idcone);
          ?>
        </div>
