...
<body>  
  <div class="conten">
      ...
      if($fila=mysqli_fetch_array($registro))
    {
        ...
        echo<<<END
          <form action="modificarCli.php" method="post">
            <table>
            <thead>
            <th>Campos</th>
            <th>Datos</th>
            ...
            <tr>
              ...
              <tr>
                <td>Telefono:</td>
                <td><input type="text" name="telefono" id="paterno" value='$fila[telefono]'></td>
              </tr>
              <tr>
              <td>Correo:</td>
                <td><input type="text" name="correo" id="materno" value='$fila[correo]'></td>
              </tr>
              <tr>
                <td>Contraseña:</td>
                <td><input type="text" name="contraseña" id="edad" value='$fila[contrasena]'></td>
              </tr>
              </table>
              <br>
              <br>
        ...
        ?>
        <?php
        echo("<script>alert(El Cliente de id".$id." no esta en la Base de Datos)</script>");
      }
