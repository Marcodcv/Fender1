        ...
        <nav class="navegacion">
          ...
          <li class="submenu">
              ...
              <ul class="hijos">
                ...
                <li><a href="../paginas/PedidDelete.html">Borrar</a></li>
              </ul>
            </li>
            <li class="submenu">
            <a href="#">Provedores</a>
...
<body>  
  <div class="conten">
        ...
        <?php
          ...
          echo "<th>"."Fecha";
          echo "<th>"."Cantidad";
          echo "<th>"."Estado de Envio";
          echo "<th>"."Total";
          echo "<th>"."Id Empleados";
          echo "<th>"."Id Cliente";
          echo "<th>"."Id Inventario";
          echo "</tr>";
          echo "</thead>";
          $contador=0;
          ...
          echo "<td align=center>".$fila['fecha'];
          echo "<td align=center>".$fila['cantidad'];
          echo "<td align=center>".$fila['estadoenvio'];
          echo "<td align=center>".$fila['totalc'];
          echo "<td align=center>".$fila['Empleados_id'];
          echo "<td align=center>".$fila['idcliente'];
          echo "<td align=center>".$fila['idinventario'];
