...
<body>  
  <div class="conten">
        ...
        <?php
          ...
          $id=$_POST['id'];
          $SQL="SELECT * FROM provedores WHERE (id LIKE '$id')";
          echo "<h2>"."BAJA DE PROVEDORES"."</h2>";
          echo "<hr>";
          echo "<br>";
          echo "<table>";
          echo "<thead>";
          ...
          if($fila=mysqli_fetch_array($registro))
          {
            ...
            echo "<th align=center>".$fila['nombreemp'];
            echo "<th align=center>".$fila['contacto'];
            echo "</tr>";
            echo "</table>";
            mysqli_free_result($registro)   ;
            $consulta="DELETE FROM provedores WHERE(id LIKE '$id')";
          ...
          else
          {
            ...
            <?php
            header("Location:../paginas/ProvDelete.html");
          }
          mysqli_close($idcone);
          ?>
        </div>
