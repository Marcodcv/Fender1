...
<body>  
  <div class="conten">
        ...
        <?php
          ...
          echo "<td align=center>".$fila['stock'];
          echo "<td align=center>".$fila['modelo'];
          echo "<td align=center>".$fila['marca'];
          echo "<td align=center>".$fila['tipo'];
          echo "<td align=center>".$fila['precio'];
          echo "<td align=center>".$fila['Provedores_id'];
          echo "</tr>";
          }
          echo "</table>";
