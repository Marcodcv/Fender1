...
<body>  
  ...
  <?php
      ...
      $SQL="INSERT INTO pedidos (id,fecha,cantidad,estadoenvio,totalc,Empleados_id,idcliente,idinventario) VALUES ('$id','$fecha','$cantidad','$envio','$total','$empleado','$cliente','$producto')";
      if(mysqli_query($idcone,$SQL))
      {?>
        <script>alert("Se realizo el registro con exito...")</script>
      <?php

      header("Location: ListPedidos.php");
      }else
      {?>
