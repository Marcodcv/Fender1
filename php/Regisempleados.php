...
<body>  
  ...
  <?php
      ...
      $correo=$_POST['correo'];
      $SQL="INSERT INTO empleados (nombre,correo,cargo,contrasena) VALUES('$nombre','$correo','$cargo','$contraseña')";
      if(mysqli_query($idcone,$SQL))
      {?>
        <script>alert("Se realizo el registro con exito...")</script>
      <?php

      header("Location: empleadoslistar.php");
      }else
      {?>
      ...
      include("../paginas/empleadosregistro.html");
      }
      mysqli_close($idcone);		 
