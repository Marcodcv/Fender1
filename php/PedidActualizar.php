...
<body>  
  <div class="conten">
      ...
      $SQL=" SELECT * FROM pedidos WHERE (id LIKE'$num')";
      ...
      if($fila=mysqli_fetch_array($registro))
    {
        ...
        echo<<<END
          <form action="PedidModificar.php" method="post">
            <table>
            <thead>
            <th>Campos</th>
            <th>Datos</th>
            ...
            <tr>
              ...
              <tr>
                <td>Fecha:</td>
                <td><input type="text" name="fecha" id="edad" value='$fila[fecha]'></td>
              </tr>
              <tr>
                <td>Cantidad:</td>
                <td><input type="text" name="cantidad" id="nombre" value='$fila[cantidad]'></td>
              </tr>
              <tr>
                <td>Estado de Envio:</td>
                <td><input type="text" name="envio" id="paterno" value='$fila[estadoenvio]'></td>
              </tr>
              <tr>
              <td>Total:</td>
                <td><input type="text" name="total" id="materno" value='$fila[totalc]'></td>
              </tr>
              <tr>
                <td>ID Empleado:</td>
                <td><input type="text" name="empleado" id="edad" value='$fila[Empleados_id]'></td>
              </tr>
              <tr>
                <td>ID Cliente:</td>
                <td><input type="text" name="cliente" id="edad" value='$fila[idcliente]'></td>
              </tr>
              <tr>
                <td>ID Inventario:</td>
                <td><input type="text" name="producto" id="edad" value='$fila[idinventario]'></td>
              </tr>
              </table>
              <br>
              <br>
        ...
        ?>
        <?php
        echo("<script>alert(El Pedido con id".$num." no esta en la Base de Datos)</script>");
      }
