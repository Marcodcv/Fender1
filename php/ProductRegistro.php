...
<body>  
  ...
  <?php
      ...
      $SQL="INSERT INTO inventario (stock,modelo,marca,tipo,precio,Provedores_id) VALUES('$stock','$modelo','$marca','$tipo','$precio','$Provedor')";
      ...
      include("../paginas/ProductAgregar.html");
      }
      mysqli_close($idcone);		 
