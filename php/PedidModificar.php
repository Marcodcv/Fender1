...
<body>  
  <div class="conten">
        ...
        <?php
          ...
          $inventario=$_REQUEST['producto'];

          $SQL="UPDATE pedidos SET  fecha='$fecha', cantidad='$cantidad', estadoenvio='$envio',totalc='$total', Empleados_id='$empleado',idcliente='$cliente', idinventario='$inventario' WHERE  (id LIKE '$id')";
          ...
          }else
          {
            ...
            <?php
            header("Location:../paginas/ProductActualizar.html");
          }
          mysqli_close($idcone);
          ?>
        <br>
