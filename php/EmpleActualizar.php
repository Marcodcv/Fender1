...
<body>  
  <div class="conten">
      ...
      if($fila=mysqli_fetch_array($registro))
    {
        ...
        echo<<<END
          <form action="EmpleModificar.php" method="post">
            <table>
            <thead>
            <th>Campos</th>
            <th>Datos</th>
            ...
            <tr>
              ...
              <tr>
                <td>Correo:</td>
                <td><input type="text" name="correo" id="paterno" value='$fila[correo]'></td>
              </tr>
              <tr>
              <td>Cargo:</td>
                <td><input type="text" name="cargo" id="materno" value='$fila[cargo]'></td>
              </tr>
              <tr>
              <td>Contraseña:</td>
                <td><input type="text" name="contraseña" id="materno" value='$fila[contrasena]'></td>
              </tr>
              </table>
              <br>
              <br>
        ...
        ?>
        <?php
        echo("<script>alert(El Empleado de id".$id." no esta en la Base de Datos)</script>");
      }
