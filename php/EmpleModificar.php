...
<body>  
  <div class="conten">
        ...
        <?php
          ...
          $SQL="UPDATE empleados SET  nombre='$nombre', correo='$correo', cargo='$cargo',contrasena='$contraseña' WHERE  (id LIKE '$id')";
          ...
          }else
          {
            ...
            <?php
            header("Location:../paginas/empleadosactualizar.html");
          }
          mysqli_close($idcone);
          ?>
        <br>
