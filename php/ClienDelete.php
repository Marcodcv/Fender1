  ...
  <div class="conten">
        ...
        <?php
          ...
          if($fila=mysqli_fetch_array($registro))
          {
            ...
            echo "<th align=center>".$fila['nombre'];
            echo "<th align=center>".$fila['telefono'];
            echo "<th align=center>".$fila['contrasena'];
            echo "<th align=center>".$fila['correo'];
            echo "</tr>";
            echo "</table>";
            mysqli_free_result($registro);
            $consulta="DELETE FROM clientes WHERE(id LIKE '$id')";
          ...
          else
          {
            ...
            <?php
            header("Location:../paginas/ClienDelete");
          }
          mysqli_close($idcone);
          ?>
        </div>
